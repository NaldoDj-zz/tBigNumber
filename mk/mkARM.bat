...
SET PATH=%PATH%;%cygwin_PATH%usr\bin\
    ...
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_mt.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_dyn_obj.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_mt_dyn_obj.hbp    
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_array.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_array_mt.hbp    
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_array_dyn_obj.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_array_mt_dyn_obj.hbp    
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_dbfile.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_dbfile_mt.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_dbfile_dyn_obj.hbp
    %HB_PATH%bin\hbmk2.exe -jobs=10 -cpp -compr=max -comp=mingwarm ..\hbp\tBigNtst_dbfile_mt_dyn_obj.hbp
