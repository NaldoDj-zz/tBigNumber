 ...
 */
    ...
    #pragma BEGINDUMP
        ...
        typedef struct
        {
           HB_BOOL    fIamIdle;             /* flag to prevent recursive calls of tbigNidleState() */
        ...
        } tBigNidleData, * PtBigNidleData;

        static void tBigNidleDataRelease( void * Cargo )
        {
           PtBigNidleData pIdleData = ( PtBigNidleData ) Cargo;
        ...
        static HB_TSD_NEW( s_idleData, sizeof( tBigNidleData ), NULL, tBigNidleDataRelease );
        ...
        static void tbigNidleState( void )
        {
           PtBigNidleData pIdleData = ( PtBigNidleData ) hb_stackGetTSD( &s_idleData );
        ...
        static void tbigNidleReset( void )
        {
           PtBigNidleData pIdleData = ( PtBigNidleData ) hb_stackGetTSD( &s_idleData );
        ...
        static void tbigNidleSleep( double dSeconds )
        {
           if( dSeconds >= 0 )
           {
        ...
        HB_FUNC_STATIC( TBIGNIDLEDEL )
        {
           PtBigNidleData pIdleData = ( PtBigNidleData ) hb_stackTestTSD( &s_idleData );
        ...
        HB_FUNC_STATIC( TBIGNRELEASECPU )
        {
           tbigNreleaseCPU();
        }
