...
static HB_SYMB s_opSymbols[ HB_OO_MAX_OPERATOR + 1 ] = {
   ...
   { "__OPPLUSEQUAL",         {HB_FS_MESSAGE}, {NULL}, NULL },  /* 01 */
   { "__OPMINUS",             {HB_FS_MESSAGE}, {NULL}, NULL },  /* 02 */
   { "__OPMINUSEQUAL",        {HB_FS_MESSAGE}, {NULL}, NULL },  /* 03 */
   { "__OPMULT",              {HB_FS_MESSAGE}, {NULL}, NULL },  /* 04 */
   { "__OPMULTEQUAL",         {HB_FS_MESSAGE}, {NULL}, NULL },  /* 05 */
   { "__OPDIVIDE",            {HB_FS_MESSAGE}, {NULL}, NULL },  /* 06 */
   { "__OPDIVIDEEQUAL",       {HB_FS_MESSAGE}, {NULL}, NULL },  /* 07 */
   { "__OPMOD",               {HB_FS_MESSAGE}, {NULL}, NULL },  /* 08 */
   { "__OPMODEQUAL",          {HB_FS_MESSAGE}, {NULL}, NULL },  /* 09 */
   { "__OPPOWER",             {HB_FS_MESSAGE}, {NULL}, NULL },  /* 10 */
   { "__OPPOWEREQUAL",        {HB_FS_MESSAGE}, {NULL}, NULL },  /* 11 */
   { "__OPINC",               {HB_FS_MESSAGE}, {NULL}, NULL },  /* 12 */
   { "__OPDEC",               {HB_FS_MESSAGE}, {NULL}, NULL },  /* 13 */
   { "__OPEQUAL",             {HB_FS_MESSAGE}, {NULL}, NULL },  /* 14 */
   { "__OPEXACTEQUAL",        {HB_FS_MESSAGE}, {NULL}, NULL },  /* 15 */
   { "__OPNOTEQUAL",          {HB_FS_MESSAGE}, {NULL}, NULL },  /* 16 */
   { "__OPLESS",              {HB_FS_MESSAGE}, {NULL}, NULL },  /* 17 */
   { "__OPLESSEQUAL",         {HB_FS_MESSAGE}, {NULL}, NULL },  /* 18 */
   { "__OPGREATER",           {HB_FS_MESSAGE}, {NULL}, NULL },  /* 19 */
   { "__OPGREATEREQUAL",      {HB_FS_MESSAGE}, {NULL}, NULL },  /* 20 */
   { "__OPASSIGN",            {HB_FS_MESSAGE}, {NULL}, NULL },  /* 21 */
   { "__OPINSTRING",          {HB_FS_MESSAGE}, {NULL}, NULL },  /* 22 */
   { "__OPINCLUDE",           {HB_FS_MESSAGE}, {NULL}, NULL },  /* 23 */
   { "__OPNOT",               {HB_FS_MESSAGE}, {NULL}, NULL },  /* 24 */
   { "__OPAND",               {HB_FS_MESSAGE}, {NULL}, NULL },  /* 25 */
   { "__OPOR",                {HB_FS_MESSAGE}, {NULL}, NULL },  /* 26 */
   { "__OPARRAYINDEX",        {HB_FS_MESSAGE}, {NULL}, NULL },  /* 27 */
   { "__ENUMINDEX",           {HB_FS_MESSAGE}, {NULL}, NULL },  /* 28 */
   { "__ENUMBASE",            {HB_FS_MESSAGE}, {NULL}, NULL },  /* 29 */
   { "__ENUMVALUE",           {HB_FS_MESSAGE}, {NULL}, NULL },  /* 30 */
   { "__ENUMSTART",           {HB_FS_MESSAGE}, {NULL}, NULL },  /* 31 */
   { "__ENUMSKIP",            {HB_FS_MESSAGE}, {NULL}, NULL },  /* 32 */
   { "__ENUMSTOP",            {HB_FS_MESSAGE}, {NULL}, NULL },  /* 33 */
   { "__ENUMISFIRST",         {HB_FS_MESSAGE}, {NULL}, NULL },  /* 34 */
   { "__ENUMISLAST",          {HB_FS_MESSAGE}, {NULL}, NULL },  /* 35 */
};
                             ...
                             PHB_ITEM pFunction, PHB_ITEM pInit )
{
   if( szMessage && uiClass && uiClass <= s_uiClasses )
   {
      ...
      if( uiType == HB_OO_MSG_DESTRUCTOR )
         ...
         pMessage = ( s_opSymbols + HB_OO_OP_PLUSEQUAL )->pDynSym;
      else if( strcmp( "+", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_PLUS )->pDynSym;
      else if( strcmp( "-=", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MINUSEQUAL )->pDynSym;
	  else if( strcmp( "-", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MINUS )->pDynSym;
      else if( strcmp( "*=", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MULTEQUAL )->pDynSym;
	  else if( strcmp( "*", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MULT )->pDynSym;
	  else if( strcmp( "/=", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_DIVIDEEQUAL )->pDynSym;
	  else if( strcmp( "/", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_DIVIDE )->pDynSym;	 
      else if( strcmp( "%=", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MODEQUAL )->pDynSym;	
	  else if( strcmp( "%", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_MOD )->pDynSym;
	  else if( strcmp( "^=", szMessage ) == 0 )
         pMessage = ( s_opSymbols + HB_OO_OP_POWEREQUAL )->pDynSym;	 	   
      else if( strcmp( "^", szMessage ) == 0 )
