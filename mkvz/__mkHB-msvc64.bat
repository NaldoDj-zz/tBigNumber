...
SETLOCAL ENABLEEXTENSIONS
    ...
    SET > env_msvc64.txt
        ...
        ..\..\core\bin\win\msvc64\hbmk2 -plat=win -cpu=x86_64 -jobs=10 -cpp -compr=no  -comp=msvc64 -hbcppmm- ..\hbpvz\_tbigNumber.hbp
        ..\..\core\bin\win\msvc64\hbmk2 -plat=win -cpu=x86_64 -jobs=10 -cpp -compr=max -comp=msvc64 -hbcppmm- -gui ..\hbpvz\tBigNtst.hbp
    D:
    CD D:\GitHub\tBigNumber\mkvz
